...
/* Modifications include new variables gripper_left_motor, gripper_right_motor, gripper_crane_motor */
...
/*******************************************************************************
* Declaration for crane and gripper motors
*******************************************************************************/
LokSrc::MotorController* gripper_left_motor;
LokSrc::MotorController* gripper_right_motor;
LokSrc::MotorController* crane_motor;
